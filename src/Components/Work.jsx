    ...
    <Box>
      <Accordion>
        <AccordionPanel className="p-3" label="Capgemini (AIG), Oct-2019 to Present">
          <Box className="p-4" background="light-1" overflow="auto" height="small">
        ...
        <AccordionPanel className="p-3" label="Anagh Tech (AIG), Aug-2017 to Oct-2019">
          <Box className="p-4" background="light-1" overflow="auto" height="small">
            <h4>Senior Consultant, Houston, Tx</h4>
            <ul>
              <li>
        ...
        <AccordionPanel className="p-3" label="Anagh Tech (HPE/DXE), Nov-2016 to July 2017">
          <Box className="p-4" background="light-1" overflow="auto" height="small">
        ...
        <AccordionPanel className="p-3" label="Anagh Tech (Code & Theory), June-2016 to Sep 2016">
          <Box className="p-4" background="light-1" overflow="auto" height="small">
        ...
        <AccordionPanel className="p-3" label="Utis Technologies, Jun-2015 to May 2016">
          <Box className="p-4" background="light-1" overflow="auto" height="small">
